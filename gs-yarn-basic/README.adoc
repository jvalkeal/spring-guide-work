...
----
$ ls -lt build/libs/
-rw-r--r-- 1 hadoop hadoop 35975001 Feb  2 17:39 gs-yarn-boot-simple-container-0.1.0.jar
-rw-r--r-- 1 hadoop hadoop 35973937 Feb  2 17:39 gs-yarn-boot-simple-client-0.1.0.jar
-rw-r--r-- 1 hadoop hadoop 35973840 Feb  2 17:39 gs-yarn-boot-simple-appmaster-0.1.0.jar
----
...
[source]
----
$ java -jar build/libs/gs-yarn-boot-simple-client-0.1.0.jar
----

Using a Resource Manager UI you can see status of an application.

image::rm-ui.png[Resource Manager UI]
